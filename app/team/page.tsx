...
import { CheckCircle2, Link2, Mail, ArrowRight } from "lucide-react";
                  ...
                  <div style={{ maxWidth: "340px" }}>
                    ...
                    <div style={{ display: "flex", justifyContent: "center", gap: "1.75rem" }}>
                      {member.social.linkedin && (
                        <a href={member.social.linkedin} target="_blank" rel="noopener noreferrer" style={{ opacity: 0.7, transition: "opacity 0.2s", position: "relative", width: "22px", height: "22px" }} onMouseEnter={(e) => (e.currentTarget.style.opacity = "1")} onMouseLeave={(e) => (e.currentTarget.style.opacity = "0.7")}>
                          <Image src="/linkedin.png" alt="LinkedIn" width={22} height={22} />
                        </a>
                      )}
                      {member.social.instagram && (
                        <a href={member.social.instagram} target="_blank" rel="noopener noreferrer" style={{ opacity: 0.7, transition: "opacity 0.2s", position: "relative", width: "22px", height: "22px" }} onMouseEnter={(e) => (e.currentTarget.style.opacity = "1")} onMouseLeave={(e) => (e.currentTarget.style.opacity = "0.7")}>
                          <Image src="/insta.png" alt="Instagram" width={22} height={22} />
                        </a>
                      )}
                      {member.social.portfolio && (
                        <a href={member.social.portfolio} target="_blank" rel="noopener noreferrer" style={{ opacity: 0.7, transition: "opacity 0.2s", position: "relative", width: "22px", height: "22px" }} onMouseEnter={(e) => (e.currentTarget.style.opacity = "1")} onMouseLeave={(e) => (e.currentTarget.style.opacity = "0.7")}>
                          <Image src="/portfolio.png" alt="Portfolio" width={22} height={22} />
                        </a>
                      )}
                      {member.social.facebook && (
                        <a href={member.social.facebook} target="_blank" rel="noopener noreferrer" style={{ opacity: 0.7, transition: "opacity 0.2s", position: "relative", width: "22px", height: "22px" }} onMouseEnter={(e) => (e.currentTarget.style.opacity = "1")} onMouseLeave={(e) => (e.currentTarget.style.opacity = "0.7")}>
